  ...
  return (
    <div className='mt-12'>
      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        <div className='bg-gray-100 dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$63,668.78</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        {/* Cards */}
        <div className='flex flex-warp m-3 justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div
              key={item.title}
              className='bg-gray-100 h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl'
            >
              <button
                type='button'
